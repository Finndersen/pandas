...
class ExtensionOpsMixin:
    ...
    Does not add the operator method if it already exists on the ExtensionArray
    ...
    def _add_arithmetic_ops(cls) -> None:
        for dunder_name, op in (
            ...
            if not hasattr(cls, dunder_name):
                setattr(cls, dunder_name, cls._create_arithmetic_method(op))
    ...
    def _add_comparison_ops(cls) -> None:
        for dunder_name, op in (
            ...
            if not hasattr(cls, dunder_name):
                setattr(cls, dunder_name, cls._create_comparison_method(op))
    ...
    def _add_logical_ops(cls) -> None:
        for dunder_name, op in (
            ...
            if not hasattr(cls, dunder_name):
                setattr(cls, dunder_name, cls._create_logical_method(op))

    @classmethod
    def _add_all_ops(cls) -> None:
